...
<title id="title">UCSD Pascal p-Code Machine — 1978</title>
<desc id="desc">Old-school UCSD p-System p-code machine: code segment, stack, heap, and interpreter loop — the portable virtual machine that carried Pascal to every 8-bit micro in the late 1970s.</desc>
<style>
  .bg { fill: #0a0a0b; }
  .panel { fill: #141416; stroke: #c9a86a; stroke-width: 1.6; }
  .panel-accent { fill: #1c1a14; stroke: #c9a86a; stroke-width: 1.8; }
  .gold { fill: #c9a86a; }
  .gold-dim { fill: #a88a4a; }
  .text-gold { fill: #e8d5a8; font-family: "IBM Plex Mono", ui-monospace, SFMono-Regular, monospace; }
  .text-dim { fill: #8a7f6a; font-family: "IBM Plex Mono", ui-monospace, monospace; }
  .wire { stroke: #c9a86a; stroke-width: 1.2; stroke-linecap: round; opacity: 0.9; }
  .wire-dim { stroke: #6b5e3a; stroke-width: 1; stroke-dasharray: 6 4; opacity: 0.7; }
  .chip { fill: #0f0e0c; stroke: #c9a86a; stroke-width: 1.1; }
  .led { fill: #c9a86a; }
  .led-off { fill: #2a2416; }
</style>
<rect class="bg" x="0" y="0" width="500" height="500" rx="18"/>
<!-- top plate -->
<rect class="panel-accent" x="18" y="14" width="464" height="54" rx="10"/>
<text class="text-gold" x="250" y="32" text-anchor="middle" font-size="11" letter-spacing="0.14em" font-weight="700">UCSD p-SYSTEM</text>
<text class="text-dim" x="250" y="48" text-anchor="middle" font-size="7.5" letter-spacing="0.18em">PORTABLE p-CODE MACHINE • 1978 • BOWLES • LAMPSON • WIRTH</text>
<!-- main chassis -->
<rect class="panel" x="18" y="76" width="464" height="408" rx="14"/>
<!-- left: code segment -->
<rect class="chip" x="32" y="96" width="138" height="112" rx="8"/>
<text class="text-gold" x="101" y="116" text-anchor="middle" font-size="8" font-weight="700" letter-spacing="0.12em">CODE SEGMENT</text>
<text class="text-dim" x="101" y="128" text-anchor="middle" font-size="6" letter-spacing="0.08em">p-CODE • 0..4095</text>
<!-- p-code listing -->
<g font-size="6" class="text-dim">
  <text x="44" y="144">000: LDC  1</text>
  <text x="44" y="154">001: LOD  2,3</text>
  <text x="44" y="164">002: ADJ  -4</text>
  <text x="44" y="174">003: CSP  EXP</text>
  <text x="44" y="184">004: STL  0,12</text>
  <text x="110" y="144">•</text>
  <text x="110" y="154">•</text>
  <text x="110" y="164">•</text>
</g>
<text class="text-dim" x="101" y="200" text-anchor="middle" font-size="5.5" letter-spacing="0.1em">INTERPRETED • EVERYWHERE</text>
<!-- center: interpreter -->
<rect class="panel-accent" x="184" y="96" width="132" height="112" rx="8"/>
<text class="text-gold" x="250" y="116" text-anchor="middle" font-size="8" font-weight="700" letter-spacing="0.12em">INTERPRETER</text>
<text class="text-dim" x="250" y="128" text-anchor="middle" font-size="6" letter-spacing="0.08em">FETCH • DECODE • EXECUTE</text>
<!-- fetch-decode-execute loop circles -->
<circle cx="222" cy="152" r="16" fill="none" stroke="#c9a86a" stroke-width="1.1"/>
<circle cx="250" cy="168" r="16" fill="none" stroke="#c9a86a" stroke-width="1.1"/>
<circle cx="278" cy="152" r="16" fill="none" stroke="#c9a86a" stroke-width="1.1"/>
<text class="text-gold" x="222" y="155" text-anchor="middle" font-size="5" font-weight="700">F</text>
<text class="text-gold" x="250" y="171" text-anchor="middle" font-size="5" font-weight="700">D</text>
<text class="text-gold" x="278" y="155" text-anchor="middle" font-size="5" font-weight="700">X</text>
<path d="M238 152 L244 164" class="wire" fill="none"/>
<path d="M262 164 L266 152" class="wire" fill="none"/>
<text class="text-dim" x="250" y="192" text-anchor="middle" font-size="5.5" letter-spacing="0.08em">ONE PASS • ONE STACK</text>
<!-- right: stack -->
<rect class="chip" x="330" y="96" width="138" height="112" rx="8"/>
<text class="text-gold" x="399" y="116" text-anchor="middle" font-size="8" font-weight="700" letter-spacing="0.12em">EVALUATION STACK</text>
<text class="text-dim" x="399" y="128" text-anchor="middle" font-size="6" letter-spacing="0.08em">SP • MP • NP</text>
<g>
  <rect x="344" y="138" width="110" height="10" rx="2" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <rect x="344" y="138" width="84" height="10" rx="2" fill="#c9a86a" opacity="0.92"/>
  <text class="text-gold" x="399" y="146" text-anchor="middle" font-size="5" font-weight="700">TOS → 42.0</text>
  <rect x="344" y="152" width="110" height="10" rx="2" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="399" y="160" text-anchor="middle" font-size="5">MARK STACK</text>
  <rect x="344" y="166" width="110" height="10" rx="2" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="399" y="174" text-anchor="middle" font-size="5">BASE • DATA</text>
  <rect x="344" y="180" width="110" height="10" rx="2" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7" stroke-dasharray="3 3"/>
  <text class="text-dim" x="399" y="188" text-anchor="middle" font-size="5">HEAP ↑</text>
</g>
<!-- wires between -->
<path d="M170 152 L184 152" class="wire" fill="none"/>
<path d="M316 152 L330 152" class="wire" fill="none"/>
<!-- second row: heap + I/O -->
<rect class="chip" x="32" y="222" width="214" height="92" rx="8"/>
<text class="text-gold" x="139" y="242" text-anchor="middle" font-size="8" font-weight="700" letter-spacing="0.12em">HEAP &amp; STORAGE</text>
<text class="text-dim" x="139" y="254" text-anchor="middle" font-size="6" letter-spacing="0.08em">NEW • DISPOSE • MARK • RELEASE</text>
<g>
  <rect x="44" y="264" width="64" height="30" rx="4" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="76" y="276" text-anchor="middle" font-size="5">ARENA</text>
  <text class="text-gold" x="76" y="285" text-anchor="middle" font-size="5" font-weight="600">64K</text>
  <rect x="118" y="264" width="64" height="30" rx="4" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="150" y="276" text-anchor="middle" font-size="5">POOL</text>
  <text class="text-gold" x="150" y="285" text-anchor="middle" font-size="5" font-weight="600">FREE LIST</text>
  <rect x="192" y="264" width="42" height="30" rx="4" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="213" y="276" text-anchor="middle" font-size="5">PTR</text>
  <text class="text-gold" x="213" y="285" text-anchor="middle" font-size="5" font-weight="600">SAFE</text>
</g>
<rect class="chip" x="256" y="222" width="212" height="92" rx="8"/>
<text class="text-gold" x="362" y="242" text-anchor="middle" font-size="8" font-weight="700" letter-spacing="0.12em">DEVICE &amp; KERNEL</text>
<text class="text-dim" x="362" y="254" text-anchor="middle" font-size="6" letter-spacing="0.08em">GPU ABSTRACTED AS p-MACHINE</text>
<g>
  <rect x="270" y="264" width="58" height="30" rx="4" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="299" y="276" text-anchor="middle" font-size="5">DEVICE</text>
  <text class="text-gold" x="299" y="285" text-anchor="middle" font-size="5" font-weight="600">CONTEXT</text>
  <rect x="336" y="264" width="58" height="30" rx="4" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="365" y="276" text-anchor="middle" font-size="5">KERNEL</text>
  <text class="text-gold" x="365" y="285" text-anchor="middle" font-size="5" font-weight="600">LAUNCH</text>
  <rect x="402" y="264" width="54" height="30" rx="4" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
  <text class="text-dim" x="429" y="276" text-anchor="middle" font-size="5">SYNC</text>
  <text class="text-gold" x="429" y="285" text-anchor="middle" font-size="5" font-weight="600">BARRIER</text>
</g>
<!-- third row: matrix / numerical -->
<rect class="panel" x="32" y="326" width="436" height="96" rx="8"/>
<text class="text-gold" x="250" y="346" text-anchor="middle" font-size="8" font-weight="700" letter-spacing="0.12em">NUMERICAL • MATRIX • TENSOR</text>
<text class="text-dim" x="250" y="358" text-anchor="middle" font-size="6" letter-spacing="0.08em">IEEE • BLAS • REDUCTIONS • ATTENTION</text>
<g>
  <!-- small matrix grid -->
  <g transform="translate(54,368)">
    <rect x="0" y="0" width="54" height="38" rx="3" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
    <!-- 3x3 grid -->
    <line x1="18" y1="2" x2="18" y2="36" stroke="#6b5e3a" stroke-width="0.6"/>
    <line x1="36" y1="2" x2="36" y2="36" stroke="#6b5e3a" stroke-width="0.6"/>
    <line x1="2" y1="12" x2="52" y2="12" stroke="#6b5e3a" stroke-width="0.6"/>
    <line x1="2" y1="24" x2="52" y2="24" stroke="#6b5e3a" stroke-width="0.6"/>
    <text class="text-dim" x="9" y="10" text-anchor="middle" font-size="4">a</text>
    <text class="text-dim" x="27" y="10" text-anchor="middle" font-size="4">b</text>
    <text class="text-dim" x="45" y="10" text-anchor="middle" font-size="4">c</text>
    <text class="text-gold" x="27" y="22" text-anchor="middle" font-size="4" font-weight="700">×</text>
  </g>
  <g transform="translate(122,368)">
    <rect x="0" y="0" width="72" height="38" rx="3" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
    <text class="text-dim" x="36" y="12" text-anchor="middle" font-size="5">TENSOR [B,H,N,D]</text>
    <line x1="8" y1="18" x2="64" y2="18" stroke="#6b5e3a" stroke-width="0.6"/>
    <text class="text-gold" x="36" y="28" text-anchor="middle" font-size="5" font-weight="600">STRIDE • BROADCAST</text>
  </g>
  <g transform="translate(210,368)">
    <rect x="0" y="0" width="74" height="38" rx="3" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
    <text class="text-dim" x="37" y="12" text-anchor="middle" font-size="5">REDUCE: SUM / MAX</text>
    <text class="text-gold" x="37" y="24" text-anchor="middle" font-size="5" font-weight="600">roSum • roMean</text>
    <text class="text-dim" x="37" y="32" text-anchor="middle" font-size="4">MEAN • PROD</text>
  </g>
  <g transform="translate(298,368)">
    <rect x="0" y="0" width="74" height="38" rx="3" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
    <text class="text-dim" x="37" y="12" text-anchor="middle" font-size="5">ACTIVATIONS</text>
    <text class="text-gold" x="37" y="24" text-anchor="middle" font-size="5" font-weight="600">ReLU • Sigmoid</text>
    <text class="text-dim" x="37" y="32" text-anchor="middle" font-size="4">TANH • SOFTMAX</text>
  </g>
  <g transform="translate(386,368)">
    <rect x="0" y="0" width="64" height="38" rx="3" fill="#1a1810" stroke="#6b5e3a" stroke-width="0.7"/>
    <text class="text-dim" x="32" y="12" text-anchor="middle" font-size="5">OPTIMIZER</text>
    <text class="text-gold" x="32" y="24" text-anchor="middle" font-size="5" font-weight="600">SGD • ADAM</text>
    <text class="text-dim" x="32" y="32" text-anchor="middle" font-size="4">STEP • DECAY</text>
  </g>
</g>
<!-- bottom: bus -->
<rect x="18" y="434" width="464" height="36" rx="8" fill="#0f0e0c" stroke="#c9a86a" stroke-width="1"/>
<g>
  <circle class="led" cx="40" cy="452" r="5"/>
  <circle class="led-off" cx="56" cy="452" r="5"/>
  <circle class="led" cx="72" cy="452" r="5"/>
  <circle class="led-off" cx="88" cy="452" r="5"/>
  <circle class="led" cx="104" cy="452" r="5"/>
  <text class="text-dim" x="124" y="456" font-size="6" letter-spacing="0.12em">BUS • 8-BIT • PORTABLE • 1978 — 2026 • ONE p-CODE RUNS EVERYWHERE</text>
  <text class="text-gold" x="444" y="456" text-anchor="middle" font-size="5" font-weight="700" letter-spacing="0.1em">◈ PASCAL ◈</text>
</g>
<!-- corner screws -->
<circle cx="28" cy="86" r="3" fill="#2a2416" stroke="#6b5e3a" stroke-width="0.6"/>
<circle cx="472" cy="86" r="3" fill="#2a2416" stroke="#6b5e3a" stroke-width="0.6"/>
<circle cx="28" cy="414" r="3" fill="#2a2416" stroke="#6b5e3a" stroke-width="0.6"/>
<circle cx="472" cy="414" r="3" fill="#2a2416" stroke="#6b5e3a" stroke-width="0.6"/>
</svg>
