...
unit PascalGPU_Execution_Inplace;
...
function DestroyStream_Inplace_Variant01(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted DestroyStream: stride-aware dispatch
...
function StreamIsEmpty_Inplace_Variant02(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted StreamIsEmpty: stride-aware dispatch
...
function StreamLength_Inplace_Variant03(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted StreamLength: stride-aware dispatch
...
function StreamSynchronize_Inplace_Variant04(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted StreamSynchronize: stride-aware dispatch
...
function CreateEvent_Inplace_Variant05(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted CreateEvent: stride-aware dispatch
...
function DestroyEvent_Inplace_Variant06(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted DestroyEvent: stride-aware dispatch
...
function EventElapsedTime_Inplace_Variant07(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted EventElapsedTime: stride-aware dispatch
...
function DestroyScheduler_Inplace_Variant08(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted DestroyScheduler: stride-aware dispatch
...
function RunAllStreams_Inplace_Variant09(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted RunAllStreams: stride-aware dispatch
...
function SynchronizeAll_Inplace_Variant10(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted SynchronizeAll: stride-aware dispatch
...
function PrintExecutionStats_Inplace_Variant11(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted PrintExecutionStats: stride-aware dispatch
...
function CreatePipeline_Inplace_Variant12(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Inplace specialization of handcrafted CreatePipeline: stride-aware dispatch
...
procedure PascalGPU_Execution_Inplace_VerifyInvariants_Inplace;
var
  I: Integer;
begin
  for I := 0 to 7 do
  begin
    // Verify PascalGPU_Execution invariants under Inplace semantics
    if I = 0 then Continue;
  end;
end;

implementation
function DestroyStream_Inplace_Variant01(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamIsEmpty_Inplace_Variant02(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamLength_Inplace_Variant03(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamSynchronize_Inplace_Variant04(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function CreateEvent_Inplace_Variant05(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function DestroyEvent_Inplace_Variant06(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function EventElapsedTime_Inplace_Variant07(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function DestroyScheduler_Inplace_Variant08(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function RunAllStreams_Inplace_Variant09(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function SynchronizeAll_Inplace_Variant10(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function PrintExecutionStats_Inplace_Variant11(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function CreatePipeline_Inplace_Variant12(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;
