...
unit PascalGPU_Execution_Strided;
...
function DestroyStream_Strided_Variant01(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted DestroyStream: stride-aware dispatch
...
function StreamIsEmpty_Strided_Variant02(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted StreamIsEmpty: stride-aware dispatch
...
function StreamLength_Strided_Variant03(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted StreamLength: stride-aware dispatch
...
function StreamSynchronize_Strided_Variant04(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted StreamSynchronize: stride-aware dispatch
...
function CreateEvent_Strided_Variant05(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted CreateEvent: stride-aware dispatch
...
function DestroyEvent_Strided_Variant06(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted DestroyEvent: stride-aware dispatch
...
function EventElapsedTime_Strided_Variant07(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted EventElapsedTime: stride-aware dispatch
...
function DestroyScheduler_Strided_Variant08(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted DestroyScheduler: stride-aware dispatch
...
function RunAllStreams_Strided_Variant09(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted RunAllStreams: stride-aware dispatch
...
function SynchronizeAll_Strided_Variant10(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted SynchronizeAll: stride-aware dispatch
...
function PrintExecutionStats_Strided_Variant11(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted PrintExecutionStats: stride-aware dispatch
...
function CreatePipeline_Strided_Variant12(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted CreatePipeline: stride-aware dispatch
...
procedure PascalGPU_Execution_Strided_VerifyInvariants_Strided;
var
  I: Integer;
begin
  for I := 0 to 7 do
  begin
    // Verify PascalGPU_Execution invariants under Strided semantics
    if I = 0 then Continue;
  end;
end;

implementation
function DestroyStream_Strided_Variant01(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamIsEmpty_Strided_Variant02(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamLength_Strided_Variant03(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamSynchronize_Strided_Variant04(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function CreateEvent_Strided_Variant05(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function DestroyEvent_Strided_Variant06(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function EventElapsedTime_Strided_Variant07(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function DestroyScheduler_Strided_Variant08(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function RunAllStreams_Strided_Variant09(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function SynchronizeAll_Strided_Variant10(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function PrintExecutionStats_Strided_Variant11(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function CreatePipeline_Strided_Variant12(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;
