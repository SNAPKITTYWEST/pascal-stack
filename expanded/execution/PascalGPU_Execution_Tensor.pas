...
unit PascalGPU_Execution_Tensor;
...
function DestroyStream_Tensor_Variant01(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted DestroyStream: stride-aware dispatch
...
function StreamIsEmpty_Tensor_Variant02(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted StreamIsEmpty: stride-aware dispatch
...
function StreamLength_Tensor_Variant03(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted StreamLength: stride-aware dispatch
...
function StreamSynchronize_Tensor_Variant04(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted StreamSynchronize: stride-aware dispatch
...
function CreateEvent_Tensor_Variant05(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted CreateEvent: stride-aware dispatch
...
function DestroyEvent_Tensor_Variant06(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted DestroyEvent: stride-aware dispatch
...
function EventElapsedTime_Tensor_Variant07(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted EventElapsedTime: stride-aware dispatch
...
function DestroyScheduler_Tensor_Variant08(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted DestroyScheduler: stride-aware dispatch
...
function RunAllStreams_Tensor_Variant09(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted RunAllStreams: stride-aware dispatch
...
function SynchronizeAll_Tensor_Variant10(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted SynchronizeAll: stride-aware dispatch
...
function PrintExecutionStats_Tensor_Variant11(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted PrintExecutionStats: stride-aware dispatch
...
function CreatePipeline_Tensor_Variant12(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Tensor specialization of handcrafted CreatePipeline: stride-aware dispatch
...
procedure PascalGPU_Execution_Tensor_VerifyInvariants_Tensor;
var
  I: Integer;
begin
  for I := 0 to 7 do
  begin
    // Verify PascalGPU_Execution invariants under Tensor semantics
    if I = 0 then Continue;
  end;
end;

implementation
function DestroyStream_Tensor_Variant01(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamIsEmpty_Tensor_Variant02(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamLength_Tensor_Variant03(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function StreamSynchronize_Tensor_Variant04(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function CreateEvent_Tensor_Variant05(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function DestroyEvent_Tensor_Variant06(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function EventElapsedTime_Tensor_Variant07(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function DestroyScheduler_Tensor_Variant08(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function RunAllStreams_Tensor_Variant09(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function SynchronizeAll_Tensor_Variant10(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function PrintExecutionStats_Tensor_Variant11(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function CreatePipeline_Tensor_Variant12(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;
