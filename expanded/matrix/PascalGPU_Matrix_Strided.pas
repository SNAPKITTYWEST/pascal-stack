...
function FreeMatrix_Strided_Variant01(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted FreeMatrix: stride-aware dispatch
...
function MatrixZero_Strided_Variant02(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted MatrixZero: stride-aware dispatch
...
function MatrixIdentity_Strided_Variant03(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted MatrixIdentity: stride-aware dispatch
...
function FreeTensor_Strided_Variant04(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted FreeTensor: stride-aware dispatch
...
function TensorPrint_Strided_Variant05(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted TensorPrint: stride-aware dispatch
...
function MultiHeadAttentionFree_Strided_Variant06(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted MultiHeadAttentionFree: stride-aware dispatch
...
function TensorValidate_Strided_Variant07(const Original: Pointer; Stride: TUInt32): Boolean; inline;
begin
  // Strided specialization of handcrafted TensorValidate: stride-aware dispatch
...
procedure PascalGPU_Matrix_Strided_VerifyInvariants_Strided;
var
  I: Integer;
begin
  for I := 0 to 7 do
  begin
    // Verify PascalGPU_Matrix invariants under Strided semantics
    if I = 0 then Continue;
  end;
end;

implementation
function FreeMatrix_Strided_Variant01(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function MatrixZero_Strided_Variant02(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function MatrixIdentity_Strided_Variant03(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function FreeTensor_Strided_Variant04(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function TensorPrint_Strided_Variant05(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function MultiHeadAttentionFree_Strided_Variant06(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;

function TensorValidate_Strided_Variant07(const Original: Pointer; Stride: TUInt32): Boolean;
begin
  Result := Assigned(Original) and (Stride > 0);
end;
